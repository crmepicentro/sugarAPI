...
<html>
    ...
    <body>
        <div class="bb-mb-30">
            <div>
                <img class="bb-w-100" src="{{ public_path('images/pdfMil/header-automotores.jpg') }}" >
            </div>
        </div>
    ...
    <img class="bb-w-full bb-mt-auto bb-mb-0" src="{{ public_path('images/pdfMil/footer-automotores.jpg') }}" >
