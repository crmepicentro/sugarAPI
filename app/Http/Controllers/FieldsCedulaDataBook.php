    ...
    public function dataBook(Request $request){
        ...
        try {
            ...
            $datosCotizacion =Array(
                ...
                "idCotizacionCrm"=>$idCotizacion,
                "CotizacionNum"=>$opportunities['id_cotizacion_c'],
                "TipoFinanciamiento"=>$opportunities['tipofinanciamientotext_c'],
                "TipoFinanciera"=>$opportunities['tipofinancieratext_c'],
