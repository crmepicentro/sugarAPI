    ...
    */
    ...
    'connections' => [
        ...
        'sugar_tyc_prod' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_TYC_SUGAR_PROD', '192.168.150.91'),
            'port' => env('DB_PORT_TYC_SUGAR_PROD', '3306'),
            'database' => env('DB_DATABASE_TYC_SUGAR_PROD', ''),
            'username' => env('DB_USERNAME_TYC_SUGAR_PROD', 'root'),
        ...
        'base_intermedia_tyc' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_TYC_BASE_INTERMEDIA', '192.168.150.91'),
            'port' => env('DB_PORT_TYC_BASE_INTERMEDIA', '3306'),
            'database' => env('DB_DATABASE_TYC_BASE_INTERMEDIA', 'root'),
