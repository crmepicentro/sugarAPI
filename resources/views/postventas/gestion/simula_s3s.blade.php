...
<a href="http://talleres.casabaca.local/externo/reservar-cita/cita?docidentidad={{ $auto->propietario->cedula }}&placa={{ $auto->placa }}&usuario={{ $gestionAgendado->usuario->name }}" class="btn btn-primary">Respuesta de S3S</a>
